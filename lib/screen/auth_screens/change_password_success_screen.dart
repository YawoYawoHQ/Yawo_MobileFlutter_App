...
class ChangePasswordSuccessScreen extends StatefulWidget {
  static const routeName = '/change-password-success';
  const ChangePasswordSuccessScreen({super.key});

  @override
  State<ChangePasswordSuccessScreen> createState() => _OtpSuccessScreenState();
}

class _OtpSuccessScreenState extends State<ChangePasswordSuccessScreen> {
              ...
              children: <Widget>[
                ...
                const Row(
                    ...
                    children: <Widget>[
                      ...
                      Text("Your password have been successfully\nchange", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.w400, fontSize: 16, color: Colors.black54),),
