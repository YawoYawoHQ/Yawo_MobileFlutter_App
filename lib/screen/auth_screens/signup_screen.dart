              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Text("Welcome !", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 18),),
                ...
                Row(
                    ...
                    children: <Widget>[
                      ...
                      Text("Join our community of travelers to\naccess the world today.", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.w400, fontSize: 16, color: Colors.black54),),
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(
                                ...
                                child: MaterialButton(
                                  elevation: 0,
                                  onPressed: () {
                                    Navigator.of(context).pushNamed(VerifyEmailSignUpScreen.routeName);
